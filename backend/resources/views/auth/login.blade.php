@php
    $authPageTitle = __('auth.login.title');
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <form class="mt-4 pt-2" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="flex-shrink-0">
                                                    @if(Route::has('password.request'))
                                                        <a href="{{ route('password.request') }}" class="text-muted">{{ __('auth.login.forgot_password') }}</a>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <!-- Submit Button -->
                                        <div class="mb-3">
                                            <button class="btn btn-primary w-100 waves-effect waves-light" type="submit">{{ __('auth.login.log_in') }}</button>
                                        </div>
                                    </form>
