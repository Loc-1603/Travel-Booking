        ...
        <div class="d-flex">
                    ...
                    <form class="p-3">
                        <div class="form-group m-0">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="{{ __('admin.navbar.search_placeholder') }}" aria-label="Search Result">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div class="p-4 text-center text-muted small mb-0">{{ __('admin.navbar.no_notifications') }}</div>
                </div>
            </div>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="{{ route('admin.profile') }}"><i class="mdi mdi-account font-size-16 align-middle me-1"></i> {{ __('admin.navbar.profile') }}</a>
                    <div class="dropdown-divider"></div>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="dropdown-item"><i class="mdi mdi-logout font-size-16 align-middle me-1"></i> {{ __('admin.navbar.logout') }}</button>
                    </form>
                </div>
            </div>
