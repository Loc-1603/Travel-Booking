...
<div class="container-fluid">
    <x-page-title title="{{ __('admin.vendor.support_tickets.title') }}" :breadcrumbs="[['label' => 'Vendor', 'url' => route('admin.vendor.dashboard')], ['label' => __('admin.sidebar.support')]]" />
    <x-alert />
    <div class="card mb-3">
        <div class="card-body d-flex justify-content-between align-items-center">
            <p class="mb-0">{{ __('admin.vendor.support_tickets.form.help') }}</p>
            <a href="{{ route('admin.vendor.support-tickets.create') }}" class="btn btn-primary">{{ __('admin.vendor.support_tickets.create') }}</a>
        </div>
    </div>
    <div class="card mb-3">
        <div class="card-body">
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th>{{ __('admin.vendor.support_tickets.table.replies') }}</th>
                        <th>{{ __('admin.vendor.support_tickets.table.created') }}</th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('admin.vendor.support-tickets.show', $t) }}" class="btn btn-sm btn-primary">{{ __('admin.vendor.support_tickets.view') }}</a></td>
                    </tr>
                    @empty
                    <tr><td colspan="7" class="text-muted">{{ __('admin.vendor.support_tickets.empty', ['url' => route('admin.vendor.support-tickets.create')]) }}</td></tr>
                    @endforelse
                </tbody>
            </table>
            {{ $tickets->links() }}
